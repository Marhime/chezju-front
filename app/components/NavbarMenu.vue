...
<template>
  <nav
    class="relative z-50 navbar flex items-center justify-between py-4 px-6 2xl:px-12 bg-light text-light"
  >
    ...
    <Transition name="fade">
      <div
        v-if="isOpen"
        class="lg:hidden block fixed inset-0 z-40 bg-primary p-4"
      >
        ...
        <div class="absolute bottom-4 left-4 uppercase right-4">
          <p class="text-sm">Nous contacter</p>
          <div
            class="flex items-center justify-between mt-3 text-md font-extrabold"
          >
